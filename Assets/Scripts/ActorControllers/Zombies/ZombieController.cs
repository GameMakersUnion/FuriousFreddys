...
public class ZombieController : MasterZombieScript
{
	...
	//	//we should only access "damage" through specific interfaces such as this "CauseAffectTo" method, so the access scope of damage should be private or protected
	//	return damage;
	//}
